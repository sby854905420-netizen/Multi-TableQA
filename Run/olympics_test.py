...
def filter_all_paths(variables,sheet_names) -> list:
    Paths = []
    target_node = ("id", "games_competitor")
...
def main():
    ...
    olympics_qa_pairs = get_question_answers(os.path.join(basic_path,total_question_answers_file_path),limit=10000)
    # print the distribution of the sql types among the financial question answering pairs 
    df_qa_pairs = pd.DataFrame(olympics_qa_pairs)
