...
#     G.add_edge("VEHNO", "CASEID")
#     G.add_edge("CATEGORY", "CASEID")
#     G.add_edge("CRASHYEAR", "CASEID")
#     G.add_edge("CRASHMONTH", "CASEID")
#     G.add_edge("DAYOFWEEK", "CASEID")
#     G.add_edge("CRASHTIME", "CASEID")
#     G.add_edge("EVENTS", "CASEID")
#     G.add_edge("VEHICLES", "CASEID")
#     G.add_edge("MANCOLL", "CASEID")
#     G.add_edge("SUMMARY", "CASEID")
    
#     G.add_edge("Model", "VEHNO")
#     G.add_edge("VehicleType", "VEHNO")
#     G.add_edge("ModelYear", "VEHNO")
#     G.add_edge("ActiveSafetySysNote", "VEHNO")  
#     G.add_edge("DVLONG", "VEHNO")  
#     G.add_edge("DVLAT", "VEHNO")  
#     G.add_edge("DVTOTAL", "VEHNO")  
#     G.add_edge("CRASHTYPE", "VEHNO")  
#     G.add_edge("PREFHE", "VEHNO")  
#     G.add_edge("MODELYR", "VEHNO") 
#     G.add_edge("BODYTYPE", "VEHNO")  
#     G.add_edge("BODYCAT", "VEHNO")  
#     G.add_edge("SPEEDLIMIT", "VEHNO")  
#     G.add_edge("CRITEVENT", "VEHNO") 
#     G.add_edge("CRASHCONF", "VEHNO")  
#     G.add_edge("VehicleType", "VEHNO") 
#     G.add_edge("ModelYear", "VEHNO")  
#     G.add_edge("Model", "VEHNO") 
    
#     G.add_edge("ActiveSafetySysNote", "VEHNO")  
#     G.add_edge("AntilockBrakeSystem", "ActiveSafetySysNote") 
#     G.add_edge("AdaptiveCruiseControl", "ActiveSafetySysNote")  
#     G.add_edge("AutoPedestrianAlertingSound", "ActiveSafetySysNote") 
#     G.add_edge("DynamicBrakeSupport", "ActiveSafetySysNote") 
#     G.add_edge("ForwardCollisionWarning", "ActiveSafetySysNote")  
#     G.add_edge("LaneCenteringAssistance", "ActiveSafetySysNote") 
#     G.add_edge("LaneDepartureWarning", "ActiveSafetySysNote") 
#     G.add_edge("LaneKeepingAssistance", "ActiveSafetySysNote")  
#     G.add_edge("RearAutomaticEmergencyBraking", "ActiveSafetySysNote") 
    
#     G.add_edge("EVENTNO", "CASEID")
    
#     G.add_edge("VEHNUM", "EVENTNO")
#     G.add_edge("CLASS1", "EVENTNO")
#     G.add_edge("GAD1", "EVENTNO")
#     G.add_edge("CLASS2", "EVENTNO")
#     G.add_edge("GAD2", "EVENTNO")

#     G.add_edge("OCCNO", "VEHNO")
#     G.add_edge("AGE", "OCCNO")
#     G.add_edge("HEIGHT", "OCCNO")
#     G.add_edge("WEIGHT", "OCCNO")
#     G.add_edge("ROLE", "OCCNO")
#     G.add_edge("SEATLOC", "OCCNO")
#     G.add_edge("SEX", "OCCNO")
#     G.add_edge("FETALMORT", "OCCNO")
#     G.add_edge("EYEWEAR", "OCCNO")
#     G.add_edge("POSTURE", "OCCNO")
#     G.add_edge("BELTUSE", "OCCNO")
